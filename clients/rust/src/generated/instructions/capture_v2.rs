...
impl CaptureV2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = CaptureV2InstructionData::new().try_to_vec().unwrap();
...
pub struct CaptureV2InstructionData {
    discriminator: [u8; 8],
}

impl CaptureV2InstructionData {
    pub fn new() -> Self {
        Self {
...
/// Instruction builder for `CaptureV2`.
///
/// ### Accounts:
///
...
/// `capture_v2` CPI instruction.
pub struct CaptureV2Cpi<'a, 'b> {
...
impl<'a, 'b> CaptureV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CaptureV2CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CaptureV2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` owner
...
pub struct CaptureV2CpiBuilder<'a, 'b> {
    instruction: Box<CaptureV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CaptureV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CaptureV2CpiBuilderInstruction {
            __program: program,
            owner: None,
            authority: None,
            recipe: None,
