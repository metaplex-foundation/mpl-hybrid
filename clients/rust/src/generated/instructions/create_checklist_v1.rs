...
impl CreateChecklistV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = CreateChecklistV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct CreateChecklistV1InstructionData {
    discriminator: [u8; 8],
}

impl CreateChecklistV1InstructionData {
    pub fn new() -> Self {
        Self {
...
/// Instruction builder for `CreateChecklistV1`.
///
/// ### Accounts:
///
///   0. `[writable]` recipe
...
#[derive(Default)]
pub struct CreateChecklistV1Builder {
...
impl CreateChecklistV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CreateChecklistV1 {
...
/// `create_checklist_v1` CPI accounts.
pub struct CreateChecklistV1CpiAccounts<'a, 'b> {
...
/// `create_checklist_v1` CPI instruction.
pub struct CreateChecklistV1Cpi<'a, 'b> {
...
impl<'a, 'b> CreateChecklistV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CreateChecklistV1CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CreateChecklistV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` recipe
...
///   2. `[writable, signer]` payer
///   3. `[]` system_program
pub struct CreateChecklistV1CpiBuilder<'a, 'b> {
    instruction: Box<CreateChecklistV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CreateChecklistV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CreateChecklistV1CpiBuilderInstruction {
            __program: program,
            recipe: None,
            checklist: None,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = CreateChecklistV1Cpi {
...
struct CreateChecklistV1CpiBuilderInstruction<'a, 'b> {
