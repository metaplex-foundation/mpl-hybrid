...
impl DepositCoreAssetV1 {
    pub fn instruction(
        &self,
        args: DepositCoreAssetV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = DepositCoreAssetV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct DepositCoreAssetV1InstructionData {
    discriminator: [u8; 8],
}

impl DepositCoreAssetV1InstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct DepositCoreAssetV1InstructionArgs {
    pub reversed: bool,
}

/// Instruction builder for `DepositCoreAssetV1`.
///
/// ### Accounts:
///
///   0. `[writable]` recipe
...
#[derive(Default)]
pub struct DepositCoreAssetV1Builder {
...
impl DepositCoreAssetV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = DepositCoreAssetV1 {
        ...
        let args = DepositCoreAssetV1InstructionArgs {
...
/// `deposit_core_asset_v1` CPI accounts.
pub struct DepositCoreAssetV1CpiAccounts<'a, 'b> {
...
/// `deposit_core_asset_v1` CPI instruction.
pub struct DepositCoreAssetV1Cpi<'a, 'b> {
    ...
    pub __args: DepositCoreAssetV1InstructionArgs,
}

impl<'a, 'b> DepositCoreAssetV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: DepositCoreAssetV1CpiAccounts<'a, 'b>,
        args: DepositCoreAssetV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DepositCoreAssetV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` recipe
...
///   5. `[]` mpl_core
///   6. `[]` system_program
pub struct DepositCoreAssetV1CpiBuilder<'a, 'b> {
    instruction: Box<DepositCoreAssetV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DepositCoreAssetV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DepositCoreAssetV1CpiBuilderInstruction {
            __program: program,
            recipe: None,
            checklist: None,
            asset: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = DepositCoreAssetV1Cpi {
...
struct DepositCoreAssetV1CpiBuilderInstruction<'a, 'b> {
