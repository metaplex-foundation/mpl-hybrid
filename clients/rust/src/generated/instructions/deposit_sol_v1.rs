...
impl DepositSolV1 {
    pub fn instruction(
        &self,
        args: DepositSolV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = DepositSolV1InstructionData::new().try_to_vec().unwrap();
...
pub struct DepositSolV1InstructionData {
    discriminator: [u8; 8],
}

impl DepositSolV1InstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct DepositSolV1InstructionArgs {
    pub reversed: bool,
}

/// Instruction builder for `DepositSolV1`.
///
/// ### Accounts:
///
///   0. `[writable]` recipe
...
#[derive(Default)]
pub struct DepositSolV1Builder {
...
impl DepositSolV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = DepositSolV1InstructionArgs {
...
/// `deposit_sol_v1` CPI accounts.
pub struct DepositSolV1CpiAccounts<'a, 'b> {
...
/// `deposit_sol_v1` CPI instruction.
pub struct DepositSolV1Cpi<'a, 'b> {
    ...
    pub __args: DepositSolV1InstructionArgs,
}

impl<'a, 'b> DepositSolV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: DepositSolV1CpiAccounts<'a, 'b>,
        args: DepositSolV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DepositSolV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` recipe
...
///   2. `[writable, signer]` payer
///   3. `[]` system_program
pub struct DepositSolV1CpiBuilder<'a, 'b> {
    instruction: Box<DepositSolV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DepositSolV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DepositSolV1CpiBuilderInstruction {
            __program: program,
            recipe: None,
            checklist: None,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = DepositSolV1Cpi {
...
struct DepositSolV1CpiBuilderInstruction<'a, 'b> {
