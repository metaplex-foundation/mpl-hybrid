...
impl DepositSplTokenV1 {
    pub fn instruction(
        &self,
        args: DepositSplTokenV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = DepositSplTokenV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct DepositSplTokenV1InstructionData {
    discriminator: [u8; 8],
}

impl DepositSplTokenV1InstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct DepositSplTokenV1InstructionArgs {
    pub reversed: bool,
}

/// Instruction builder for `DepositSplTokenV1`.
///
/// ### Accounts:
///
///   0. `[writable]` recipe
...
#[derive(Default)]
pub struct DepositSplTokenV1Builder {
...
impl DepositSplTokenV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = DepositSplTokenV1 {
        ...
        let args = DepositSplTokenV1InstructionArgs {
...
/// `deposit_spl_token_v1` CPI accounts.
pub struct DepositSplTokenV1CpiAccounts<'a, 'b> {
...
/// `deposit_spl_token_v1` CPI instruction.
pub struct DepositSplTokenV1Cpi<'a, 'b> {
    ...
    pub __args: DepositSplTokenV1InstructionArgs,
}

impl<'a, 'b> DepositSplTokenV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: DepositSplTokenV1CpiAccounts<'a, 'b>,
        args: DepositSplTokenV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DepositSplTokenV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` recipe
...
///   8. `[]` system_program
pub struct DepositSplTokenV1CpiBuilder<'a, 'b> {
    instruction: Box<DepositSplTokenV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DepositSplTokenV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DepositSplTokenV1CpiBuilderInstruction {
            __program: program,
            recipe: None,
            checklist: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = DepositSplTokenV1Cpi {
...
struct DepositSplTokenV1CpiBuilderInstruction<'a, 'b> {
