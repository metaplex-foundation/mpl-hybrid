...
impl InitEscrowV1 {
    pub fn instruction(
        &self,
        args: InitEscrowV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InitEscrowV1InstructionData::new().try_to_vec().unwrap();
...
pub struct InitEscrowV1InstructionData {
    discriminator: [u8; 8],
}

impl InitEscrowV1InstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct InitEscrowV1InstructionArgs {
    pub name: String,
    pub uri: String,
    pub max: u64,
    pub min: u64,
...
/// Instruction builder for `InitEscrowV1`.
///
/// ### Accounts:
///
///   0. `[writable]` escrow
...
#[derive(Default)]
pub struct InitEscrowV1Builder {
...
impl InitEscrowV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = InitEscrowV1InstructionArgs {
...
/// `init_escrow_v1` CPI accounts.
pub struct InitEscrowV1CpiAccounts<'a, 'b> {
...
/// `init_escrow_v1` CPI instruction.
pub struct InitEscrowV1Cpi<'a, 'b> {
    ...
    pub __args: InitEscrowV1InstructionArgs,
}

impl<'a, 'b> InitEscrowV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: InitEscrowV1CpiAccounts<'a, 'b>,
        args: InitEscrowV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `InitEscrowV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` escrow
...
pub struct InitEscrowV1CpiBuilder<'a, 'b> {
    instruction: Box<InitEscrowV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InitEscrowV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(InitEscrowV1CpiBuilderInstruction {
            __program: program,
            escrow: None,
            authority: None,
            collection: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = InitEscrowV1Cpi {
...
struct InitEscrowV1CpiBuilderInstruction<'a, 'b> {
