...
impl InitNftDataV1 {
    pub fn instruction(
        &self,
        args: InitNftDataV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InitNftDataV1InstructionData::new().try_to_vec().unwrap();
...
pub struct InitNftDataV1InstructionData {
    discriminator: [u8; 8],
}

impl InitNftDataV1InstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct InitNftDataV1InstructionArgs {
    pub name: String,
    pub uri: String,
    pub max: u64,
    pub min: u64,
...
/// Instruction builder for `InitNftDataV1`.
///
/// ### Accounts:
///
///   0. `[writable]` nft_data
...
#[derive(Default)]
pub struct InitNftDataV1Builder {
...
impl InitNftDataV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = InitNftDataV1InstructionArgs {
...
/// `init_nft_data_v1` CPI accounts.
pub struct InitNftDataV1CpiAccounts<'a, 'b> {
...
/// `init_nft_data_v1` CPI instruction.
pub struct InitNftDataV1Cpi<'a, 'b> {
    ...
    pub __args: InitNftDataV1InstructionArgs,
}

impl<'a, 'b> InitNftDataV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: InitNftDataV1CpiAccounts<'a, 'b>,
        args: InitNftDataV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `InitNftDataV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` nft_data
...
///   5. `[]` fee_location
///   6. `[]` system_program
pub struct InitNftDataV1CpiBuilder<'a, 'b> {
    instruction: Box<InitNftDataV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InitNftDataV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(InitNftDataV1CpiBuilderInstruction {
            __program: program,
            nft_data: None,
            authority: None,
            asset: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = InitNftDataV1Cpi {
...
struct InitNftDataV1CpiBuilderInstruction<'a, 'b> {
